...
import { CustomRequestStatus, Status } from "src/utils/enums";
...
function DesignTimeline(props: IStaffDesignTimelineProps) {
  ...
  return (
    ...
    >
      ...
      {designResponse?.data && designResponse.data.items.length > 0 && (
        <TimelineItem>
          <TimelineOppositeContent color="textSecondary">
            {moment(designResponse.data.items[0].createdAt).format(
              "DD/MM/YYYY HH:mm"
            )}
          </TimelineOppositeContent>
          <TimelineSeparator>
